...
/*export function createAdminEvent(
  ...
  price,
  imgSrc) {
    const adminEvent = createAdminEvent();
    adminEvent.setName(name);
    adminEvent.setOrganizer(organizer);
    adminEvent.setTime(startTime, endTime);
