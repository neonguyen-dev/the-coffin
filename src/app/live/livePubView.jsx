    ...
    return(
        <div className="bg-gray-800 min-h-screen p-10">
            ...
            <form className="flex items-center justify-left m-2">
                <input onChange={handleExternalInputChange} value={externalInputValue} placeholder="Add +1" className="px-4 py-2 text-black h- m-2 rounded-full justify-center"/>
                <button onClick={handleExternalInputSubmit} className="bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 py-2 w-auto m-2 rounded">Add +1</button>
            </form>)}
